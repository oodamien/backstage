...
const LogoFull = () => {
  ...
  return (
    <svg
      version="1.1"
      viewBox="0 0 190.2 31"
      xmlns="http://www.w3.org/2000/svg"
      className={classes.svg}
    >
      <title>VMware logo</title>
      <desc>
        An information technology company based in Palo Alto, California, United
        States
      </desc>
